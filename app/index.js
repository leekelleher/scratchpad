...
const tools = [
    ...
    { name: 'datetime', footer: true, action: () => import('../tools/datetime/index.js') },
    { name: 'html-format', footer: true, action: () => import('../tools/html-format/index.js') },
    { name: 'json-format', footer: true, action: () => import('../tools/json-format/index.js') },
    ...
    { name: 'password', footer: true, action: () => import('../tools/password/index.js') },
