...
const tools = [
    ...
    { name: 'dark', toolbar: true, icon: 'icon-dark', action: () => import('../tools/dark/index.js') },
    { name: 'dl', toolbar: true, icon: 'icon-dl', action: () => import('../tools/download/index.js') },
    { name: 'datetime', toolbar: true, icon: 'icon-datetime', action: () => import('../tools/datetime/index.js') },
    { name: 'html-format', toolbar: true, icon: 'icon-html-format', action: () => import('../tools/html-format/index.js') },
    { name: 'json-format', toolbar: true, icon: 'icon-json-format', action: () => import('../tools/json-format/index.js') },
    { name: 'jwt', toolbar: true, icon: 'icon-jwt', action: () => import('../tools/jwt/index.js') },
    { name: 'md', toolbar: true, icon: 'icon-md', action: () => import('../tools/markdown/index.js') },
    { name: 'passphrase', description: 'Generate a passphrase using the EFF short word list', action: () => import('../tools/passphrase/index.js') },
    { name: 'password', toolbar: true, icon: 'icon-password', action: () => import('../tools/password/index.js') },
    ...
    { name: 'uuid', toolbar: true, icon: 'icon-uuid', action: () => import('../tools/uuid/index.js') },
